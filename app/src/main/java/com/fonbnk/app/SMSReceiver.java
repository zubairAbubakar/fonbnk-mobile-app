...
public class SMSReceiver extends BroadcastReceiver {
    ...
    private static final String MTN_AIRTIME_SHARING_SHORTCODE = "777";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (intent.getAction() == SMS_RECEIVED){
            ...
            if(dataBundle != null) {
                ...
                if(telcoPhoneNo.equals(MTN_AIRTIME_SHARING_SHORTCODE)){
                    ...
                    Toast.makeText(context, "Transaction details updated successfully! \nMessage: "
                                    +msg +"\nNumber: "+telcoPhoneNo + "\nAmount & SenderNumber from SMS:"+amount+" No."+senderNumber,
                            Toast.LENGTH_SHORT).show();
                }
            }
